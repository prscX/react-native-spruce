...
class ContinuousSort {
  ...
  toJSON() {
    return { name: "ContinuousSort", interObjectDelay: this.interObjectDelay, reversed: this.reversed, position: this.position };
  }
}

export { ContinuousSort }